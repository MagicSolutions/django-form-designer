...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormDefinitionField.choice_empty_label'
        db.add_column('form_designer_formdefinitionfield', 'choice_empty_label',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormDefinitionField.choice_empty_label'
        db.delete_column('form_designer_formdefinitionfield', 'choice_empty_label')
